...
param+="run_mode=MP2-PP4-sharding4-mbs1-acc32 "
...
#多机新添加的参数
param+="pipeline_parallel_config=enable_sharding_comm_overlap,enable_release_grads,enable_dp_comm_overlap,enable_overlap_p2p_comm "
